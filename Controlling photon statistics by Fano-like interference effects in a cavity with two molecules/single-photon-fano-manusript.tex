...
\begin{equation}
\begin{split}
\Gamma^{-}_{p}&=-(2\pi/\hbar)\sum_{\alpha,\beta}|\langle\beta|M|\alpha\rangle|^{2}[f_{\beta}(\varepsilon_{\beta}-\mu_{\beta})-f_{\alpha}(\varepsilon_{\alpha}-\mu_{\alpha})][n_{B}(\varepsilon_{p}-eV)+1]\\
&\times\delta(\varepsilon_{\alpha}-\varepsilon_{\beta}+\varepsilon_{p}),
\end{split}
\end{equation}
